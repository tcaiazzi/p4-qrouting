...
def plot_for_link_selection(link_selection_value, results_path, workload_csv_dir, _SYSTEMS, topology_tag):
    ...
    figures_root = os.path.join("use_case_figures", topology_tag)
    base_figures_path = os.path.join(figures_root, f"use-case-dense-6-{congestion_link_selection}")
    ...
    #             experiment_path,
    #             f"{topology_tag}-throughput-{congestion_control}-{wl}",
    ...
    #             ],
    #             f"{topology_tag}-delay-cdf-{congestion_control}-{wl}",
    #             ylim=(0.8, 1.00001),
    #             xlim=None,
    #         )
    ...
    #             ],
    #             f"{topology_tag}-fct-histogram-{congestion_control}-{wl}",
    #         )
    ...
    #                 for port, lbl, col, sty, rel in _rel_cdf
    #             ],
    #             f"{topology_tag}-ipg-cdf-{congestion_control}-{wl}",
    #         )
    ...
    #                 for port, lbl, col, sty, rel in _rel_cdf
    #             ],
    #             f"{topology_tag}-jitter-cdf-{congestion_control}-{wl}",
    #         )
    ...
    #                 for port, lbl, col, sty, rel in _rel_cdf
    #             ],
    #             f"{topology_tag}-deadline-miss-{congestion_control}-{wl}",
    ...
    #     results_path,
    #     _rel_cdf,
    #     f"{topology_tag}-delay-cdf-cumulative",
    #     ylim=(0.8, 1.00001),
    #     xlim=None,
    ...
    #     results_path,
    #     _rel_cdf,
    #     f"{topology_tag}-rx-bytes-comparison",
    #     link_selection_tag=congestion_link_selection,
    #     exclude_seeds=EXCLUDE_SEEDS,
    # )
    ...
    #     results_path,
    #     _rel_cdf,
    #     f"{topology_tag}-avg-throughput-comparison",
    #     link_selection_tag=congestion_link_selection,
    #     exclude_seeds=EXCLUDE_SEEDS,
    # )

    paper_plot.plot_deadline_miss_bar_all_experiments(
        results_path, _rel_cdf, f"{topology_tag}-deadline-miss-aggregate",
        slo_ms_list=(10, 20, 50, 150),
        link_selection_tag=congestion_link_selection,
    ...
    # for ce in ce_values:
    #     paper_plot.plot_deadline_miss_bar_all_experiments(
    #         results_path, _rel_cdf, f"{topology_tag}-deadline-miss-aggregate-ce{ce}",
    #         slo_ms_list=(10, 20, 50, 150),
    #         link_selection_tag=congestion_link_selection,
    #         ce_filter=ce,
    #         workload_csv_dir=workload_csv_dir,
    ...
    # if ce_values:
    #     # Same panels as {topology}-deadline-miss-aggregate-ce<N>.pdf above, side by
    #     # side in one figure/file with a single shared legend.
    #     paper_plot.plot_deadline_miss_bar_by_ce_subplots_figure(
    #         results_path, _rel_cdf, f"{topology_tag}-deadline-miss-aggregate-by-ce",
    #         ce_values=ce_values,
    #         slo_ms_list=(10, 20, 50, 150),
    #         link_selection_tag=congestion_link_selection,
    #         workload_csv_dir=workload_csv_dir,
    ...
    #         results_path, _rel_cdf, f"{topology_tag}-deadline-miss-aggregate-by-free-occupied",
    ...
    #     paper_plot.plot_deadline_miss_bar_all_experiments(
    #         results_path, _rel_cdf, f"{topology_tag}-deadline-miss-aggregate-prot{pfc}",
    #         slo_ms_list=(10, 20, 50, 150),
    #         link_selection_tag=congestion_link_selection,
    #         pfc_filter=pfc,
    #         exclude_seeds=EXCLUDE_SEEDS,
    ...
    # if pfc_values:
    #     # Same panels as {topology}-deadline-miss-aggregate-prot<N>.pdf above, side
    #     # by side in one figure/file with a single shared legend.
    #     paper_plot.plot_deadline_miss_bar_by_pfc_subplots_figure(
    #         results_path, _rel_cdf, f"{topology_tag}-deadline-miss-aggregate-by-pfc",
    ...
    #     results_path, _rel_cdf, f"{topology_tag}-protected-flow-slo_99",
    ...
    # paper_plot.plot_protected_flow_slo_comparison(
    #     results_path, _rel_cdf, f"{topology_tag}-protected-flow-slo_95",
    ...
    # paper_plot.plot_protected_flow_slo_comparison(
    #     results_path, _rel_cdf, f"{topology_tag}-protected-flow-slo_90",
...
def main():
    # Resources tag for each topology being plotted (must match RESOURCES_TAG
    # used at run time). Drives both the results_<topology> dir this pass
    # reads from and resources/<topology>/workloads it reads SLO/CE data
    # from. Figures for each topology land in use_case_figures/<topology>.
    topologies = ("abilene", "atlanta", "pdh")
    ...
    for resources_tag in topologies:
        results_path = f"results_{resources_tag}"
        ...
        for link_selection_value in ("deepest", "waypoint-random"):
            print(f"=== plot_zoo: topology={resources_tag} congestion_link_selection={link_selection_value} ===")
            plot_for_link_selection(link_selection_value, results_path, workload_csv_dir, _SYSTEMS, resources_tag)
