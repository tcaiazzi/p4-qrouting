...
MODE=central P4_PROGRAM=examples/qlrouting/fwd_build/fwd.json EXPERIMENT_NAME=${EXPERIMENT_NAME} CONGESTION_CONTROL=${CONGESTION_CONTROL} WORKLOAD_FILE=${WORKLOAD_FILE} EDGES="0,1;0,2;1,2" HOSTS="1,1,1" SWITCHES=3 DAGS="" END=10 bash run_experiment.sh
