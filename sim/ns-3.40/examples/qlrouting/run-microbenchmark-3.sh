...
QLR_ACTIVE=0 EXPERIMENT_NAME=${EXPERIMENT_NAME} CONGESTION_CONTROL=${CONGESTION_CONTROL} WORKLOAD_FILE=${WORKLOAD_FILE} EDGES="0,1;1,2;0,3;3,4;2,4" HOSTS="1,1,1,1,1" SWITCHES=5 DAGS="0:1-0,2-1,3-0,4-3,2-4;1:0-1,2-1,3-0,4-3,4-2;2:0-1,1-2,0-3,3-4,4-2;3:0-3,4-3,1-0,2-1;4:3-4,2-4,1-2,0-1,0-3" QLR_UPDATE_INTERVAL=10ms END=10 bash run_experiment.sh
