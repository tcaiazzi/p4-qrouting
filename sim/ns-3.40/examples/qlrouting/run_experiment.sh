...
../../ns3 run qlr-experiment -- $experiment_params_cc --results-path="examples/qlrouting/$RESULTS_PATH/qlr_${QLR_ACTIVE}/$i/" --seed=$SEED  |& tee $RESULTS_PATH/qlr_${QLR_ACTIVE}/$i/run_$i.log
